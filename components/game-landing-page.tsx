    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-900 via-purple-800 to-purple-950 text-white overflow-hidden relative">
      ...
      <header className="relative z-10 flex justify-between items-center p-4 border-b border-purple-500/30">
        ...
        <nav className="hidden md:flex gap-6">
          ...
          <Link href="https://www.x.com/CockCombatBNB" target="_blank" rel="noopener noreferrer" className="text-purple-300 hover:text-white transition-colors">
            Twitter
          </Link>
        ...
        <section className="block sm:hidden px-4 pt-4">
          <div className="rounded-lg border border-white/10 bg-white/5 p-3 shadow">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs text-purple-200">Follow us</span>
              <div className="flex items-center gap-2">
                <a href="https://www.x.com/CockCombatBNB" target="_blank" rel="noopener noreferrer" aria-label="X" className="p-2 rounded-md border border-white/10 bg-white/5">
