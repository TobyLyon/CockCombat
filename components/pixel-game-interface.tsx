    ...
    <div className="h-screen w-screen overflow-hidden relative bg-gradient-to-b from-[#87CEEB] via-[#B0D4E3] to-[#E8F4F8] flex flex-col">
      ...
      <div className="absolute top-8 left-1/2 transform -translate-x-1/2 z-30 text-center pointer-events-none">
        <div className="relative inline-block">
          <h1 className="text-5xl md:text-7xl font-black text-white drop-shadow-[0_0_40px_rgba(0,0,0,1)] [text-shadow:_8px_8px_0_rgb(0_0_0_/_80%)] mb-2 pixel-font leading-none">
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 z-30 flex items-center justify-center gap-2 sm:gap-4 bottom-20 sm:bottom-48">
      ...
      <div className="absolute bottom-2 left-1/2 -translate-x-1/2 z-30 w-[calc(100%-1rem)] max-w-md sm:hidden pointer-events-auto">
        <div className="rounded-lg border border-white/10 bg-white/10 backdrop-blur-sm p-3 shadow">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-purple-100">Follow us</span>
            <div className="flex items-center gap-2">
              ...
              <a href="https://www.tiktok.com/@cockcombatgame" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="p-2 rounded-md border border-white/10 bg-white/5">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" fill="#00F2EA"/></svg>
              </a>
            </div>
          </div>
          <div className="mt-2">
            <div className="w-full text-left text-[11px] font-mono tracking-tight p-2 rounded-md border border-white/10 bg-white/5" aria-label="Token contract address">
              <span className="text-purple-200">Token:</span>
              <span className="ml-1 text-purple-100">V6CRprMSfhuETeSCfWm4SL8dfr6KFRwTnUWB6NQpump</span>
            </div>
          </div>
        </div>
      </div>
